...
namespace Quarter3Project.Managers
{
    class DebugManager : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            debugList.Add(new Debug.text(Consolas, "Current Level: " + g.CurrentLevel.ToString(), new Vector2(20, 20), Color.White));
            debugList.Add(new Debug.text(Consolas, "Previous Level: " + g.PrevLevel.ToString(), new Vector2(20, 35), Color.White));
            debugList.Add(new Debug.text(Consolas, "Pop #: " + g.popManager.idn.ToString(), new Vector2(20, 50), Color.White));
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                debugList[0] = new Debug.text(debugList[0].font, "Current Level: " + g.CurrentLevel.ToString(), debugList[0].position, debugList[0].textColor);
                debugList[1] = new Debug.text(debugList[1].font, "Previous Level: " + g.PrevLevel.ToString(), debugList[1].position, debugList[1].textColor);
